...
@pre<ShowModel>('save', preSaveHook)
export class ShowModel extends Typegoose {
    @prop({ unique: true })
    @JsonProperty()
    email: string;
...
export type UserInstance = InstanceType<ShowModel>;
export type UserRepository = ModelType<ShowModel>;
InjectorService.factory(UserRepositoryToken, new ShowModel().getModelForClass(ShowModel));
